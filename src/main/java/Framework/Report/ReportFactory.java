...
public class ReportFactory {
    ...
    public static void configReportExtent() {
        ...
        extentSparkReporter.config().setDocumentTitle("Relatorio de Execucao Automacao SenacTech");
        extentSparkReporter.config().setReportName("Relatorio de Testes");
        ...
        extentSparkReporter.config().setJs("$('.nav-logo').html('<img src=\"https://i.imgur.com/WkFG4iY.png\" class=\"ioda-logo\"/>');");
