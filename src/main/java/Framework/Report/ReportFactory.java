...
public class ReportFactory {
    ...
    public static void configReportExtent() {
        ...
        extentSparkReporter.config().setDocumentTitle("Relat�rio de Execu��o Automa��o Capacita��o");
        extentSparkReporter.config().setReportName("Relat�rio de Execu��o de Testes");
